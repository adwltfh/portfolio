...
const POLAROID_CONFIG = [
  { rotate: '-rotate-2', shadow: 'shadow-[4px_4px_0_#ff8fb3]', imgBg: 'linear-gradient(135deg,#ffd5e5 50%,#fff3a8 50%)' },
  { rotate: 'rotate-2',  shadow: 'shadow-[4px_4px_0_#f5d96b]', imgBg: '#e1d2ff' },
  { rotate: 'rotate-1',  shadow: 'shadow-[4px_4px_0_#82c2f0]', imgBg: 'linear-gradient(135deg,#c9e7ff 50%,#c9f3d8 50%)' },
  { rotate: '-rotate-1', shadow: 'shadow-[4px_4px_0_#b59cf0]', imgBg: '#fff3a8' },
  { rotate: '-rotate-2', shadow: 'shadow-[4px_4px_0_#ff8fb3]', imgBg: 'linear-gradient(135deg,#c9f3d8 50%,#ffd5e5 50%)' },
  { rotate: 'rotate-2',  shadow: 'shadow-[4px_4px_0_#f5d96b]', imgBg: '#c9e7ff' },
]
  ...
  return (
    <>
          ...
          {PROJECT_LIST.map((p, i) => {
            ...
            return (
              ...
              >
                ...
                <h4 className="font-caprasimo text-[18px] leading-[1.1] mb-[2px]">{p.title}</h4>
                <div className="font-fraunces italic text-[12px] text-resume-ink-soft mb-[6px]">{p.kicker}</div>
      ...
      <div
        ...
        style={{ background: 'rgba(58,42,85,0.45)', backdropFilter: 'blur(4px)' }}
        role="dialog"
        aria-modal="true"
          ...
          {project && (
            <>
              ...
              <div className="p-[26px_28px_28px]">
                <h3 id="modal-title" className="font-caprasimo text-[32px] leading-[1.05] mb-1">
                  {project.title}
                </h3>
                ...
                <div className="mb-[22px]">
                  ...
                  <p className="font-fraunces text-[17px] leading-[1.5] text-resume-ink m-0" style={{ textWrap: 'pretty' } as React.CSSProperties}>
                    {project.desc}
                  </p>
                </div>
